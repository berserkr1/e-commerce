...
// ________ HUB ________
	...
	$access_admin = array('404', 'home', 'create_category', 'category', 'subcategory', 'create_product', 'list-product', 'product', 'basket', 'profil', 'logout', 'dashboard_user', 'dashboard_message', 'dashboard_sections', 'dashboard_order');
	...
	$traitements_admin = array('create_category'=>'sections', 'create_product'=>'product', 'product'=>'product', 'basket'=>'basket', 'profil'=>'user', 'logout'=>'user', 'dashboard_user'=>'user', 'dashboard_message'=>'message', 'dashboard_order'=>'order');
