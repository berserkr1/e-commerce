...
class AddressManager
{
	...
	public function create($id_user, $ship_address, $ship_city, $ship_postal_code, $ship_region, $ship_country, $bill_address, $bill_city, $bill_postal_code, $bill_region, $bill_country)
	{
		$errors = array();
		...
		if (count($errors) == 0)
		{
			...
			$query = "INSERT INTO address (ship_address, ship_city, ship_postal_code, ship_region, ship_country, bill_address, bill_city, bill_postal_code, bill_region, bill_country) VALUES(".$ship_address.", ".$ship_city.", ".$ship_postal_code.", ".$ship_region.", ".$ship_country.", ".$bill_address.", ".$bill_city.", ".$bill_postal_code.", ".$bill_region.", ".$bill_country.")";
